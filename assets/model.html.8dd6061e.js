...
`),s("span",{class:"line"},[s("span",{style:{color:"#F8F8F2"}},[s("data-lsp",{lsp:"const ctx: Context"},"ctx"),l("."),s("data-lsp",{lsp:"(property) Context.model: DatabaseService"},"model"),l(".")]),s("span",{style:{color:"#A6E22E"}},[s("data-lsp",{lsp:`(method) Database<Tables>.extend<"user">(name: "user", fields: MapField<{
    id?: string;
} & {
    flag?: number;
} & {
...
`),s("span",{class:"line"},[s("span",{style:{color:"#F8F8F2"}},"}")]),l(`
`),s("span",{class:"line"},"\xA0"),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#F8F8F2"}},[s("data-lsp",{lsp:"const ctx: Context"},"ctx"),l("."),s("data-lsp",{lsp:"(property) Context.model: DatabaseService"},"model"),l(".")]),s("span",{style:{color:"#A6E22E"}},[s("data-lsp",{lsp:`(method) Database<Tables>.extend<"schedule">(name: "schedule", fields: MapField<{
    id?: number;
} & {
    assignee?: string;
} & {
